...
defmodule Mix.Tasks.Lei.GenerateRules do
  ...
  def build_thresholds(opts) do
    %{
      contributor_critical:
        opt_or_config(opts, :contributor_critical, :critical_contributor_level, 2),
      ...
      functional_critical:
        opt_or_config(opts, :functional_critical, :critical_functional_contributors_level, 2),
      functional_high:
        opt_or_config(opts, :functional_high, :high_functional_contributors_level, 3),
      functional_medium:
        opt_or_config(opts, :functional_medium, :medium_functional_contributors_level, 5),
      large_commit_critical:
        opt_or_config(opts, :large_commit_critical, :critical_large_commit_level, 0.40),
      large_commit_high: opt_or_config(opts, :large_commit_high, :high_large_commit_level, 0.30),
      large_commit_medium:
        opt_or_config(opts, :large_commit_medium, :medium_large_commit_level, 0.20)
    }
  end
