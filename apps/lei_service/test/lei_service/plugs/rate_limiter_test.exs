defmodule LeiService.Plugs.RateLimiterTest do
  use ExUnit.Case, async: false
  use Plug.Test

  alias LeiService.Plugs.RateLimiter
  ...
  describe "configurable limit" do
    test "respects :analyze_rate_limit application env" do
      Application.put_env(:lei_service, :analyze_rate_limit, 3)
      RateLimiter.clear()
      prefix = "config_limit"
      ...
      assert result.status == 429
    after
      Application.delete_env(:lei_service, :analyze_rate_limit)
    end
  end
end
