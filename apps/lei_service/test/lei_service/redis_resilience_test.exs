defmodule LeiService.RedisResilienceTest do
  @moduledoc """
  ...
  setup do
    ...
    Application.put_env(:lei_service, :redix_name, @dead_conn)

    on_exit(fn ->
      if previous do
        Application.put_env(:lei_service, :redix_name, previous)
      else
        Application.delete_env(:lei_service, :redix_name)
      end
    end)
