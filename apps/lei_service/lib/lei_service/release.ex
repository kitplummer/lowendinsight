defmodule LeiService.Release do
  @moduledoc """
  ...
  version takes traffic:
      ...
      /opt/app/bin/lei_service eval 'LeiService.Release.migrate()'
  ...
  `Lei.Repo` migrates first: it owns orgs and api_keys, which lei_service
