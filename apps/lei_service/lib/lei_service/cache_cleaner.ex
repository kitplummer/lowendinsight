...
defmodule LeiService.CacheCleaner do
  require Logger

  def clean() do
    cache_ttl = Application.get_env(:lei_service, :cache_ttl, 2_592_000)
    ...
    case Redix.command(conn, ["GET", key]) do
      ...
      {:ok, json} ->
        ...
        if value["header"]["end_time"] != nil do
          cache_ttl = Application.get_env(:lei_service, :cache_ttl) * 86400
  ...
  def get_report_time(_value, _force_delete?) do
    Application.get_env(:lei_service, :cache_ttl) * 86400
  end
end
