defmodule LeiService.Plugs.RateLimiter do
  @moduledoc """
  ...
  `:lei_service, :analyze_rate_limit`). JWT-authenticated and unauthenticated
  ...
  defp check_rate(conn, key) do
    limit = Application.get_env(:lei_service, :analyze_rate_limit, @default_limit)
