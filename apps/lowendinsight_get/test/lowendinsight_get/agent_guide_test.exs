defmodule LowendinsightGet.AgentGuideTest do
  @moduledoc """
  ...
  alias LowendinsightGet.AgentGuide
  ...
  defp page, do: conn(:get, "/") |> LowendinsightGet.Endpoint.call(@opts)
  defp llms, do: conn(:get, "/llms.txt") |> LowendinsightGet.Endpoint.call(@opts)
