defmodule LowendinsightGet.TenantIsolationTest do
  @moduledoc """
  ...
  export the shared cache. Driven through LowendinsightGet.Endpoint, the
  deployed stack.
  """
  ...
  setup do
    ...
    Application.put_env(
      :lowendinsight,
      :jwt_secret,
      Application.get_env(:lowendinsight_get, :jwt_secret)
    )
