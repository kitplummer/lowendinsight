defmodule LowendinsightGet.ReportDetailPageTest do
  @moduledoc """
  ...
  test "the project is linked only when its URL is http or https" do
    ...
    assert LowendinsightGet.ReportView.project_href("javascript:alert(1)") == nil

    assert LowendinsightGet.ReportView.project_href("https://github.com/o/r") ==
