...
Nine stages: format, compile (warnings are errors), databases, suite, guards,
library isolation, dependency audit, seed sweep, backup grants. CI runs the same script. When local and CI disagree
