defmodule Lei.BatchAnalyzer do
  ...
  Checks cache for each dependency, returns cached results immediately,
  and enqueues Oban jobs for cache misses.
  """
  ...
  defp check_or_enqueue(%{"ecosystem" => ecosystem, "package" => package} = dep) do
    ...
    case Lei.Cache.get(ecosystem, package, version) do
      {:ok, result} ->
        {:cached, result}
